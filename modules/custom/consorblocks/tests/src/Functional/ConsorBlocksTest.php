 ...
 * @group examples
 */
class ConsorBlocksTest extends BrowserTestBase {
   ...
   */
  public function testConsorBlocksBasic() {
    ...
    $settings_configurable = array(
      ...
      'id' => 'consorblocks_example_configurable_text',
      'theme' => $theme_name,
    );
    ...
    $settings_uppercase = array(
      ...
      'id' => 'consorblocks_example_uppercased',
      'theme' => $theme_name,
    );
    ...
    $edit = array(
      'settings[consorblocks_string_text]' => $this->randomMachineName(),
    );
    ...
    $this->drupalGet('');
    $assert->statusCodeEquals(200);
    $assert->pageTextContains($edit['settings[consorblocks_string_text]']);
  }
