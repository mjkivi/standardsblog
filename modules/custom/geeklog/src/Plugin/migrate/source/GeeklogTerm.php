 ...
 * implemented by this class is "geeklog_term". This is the name that the migration
 ...
 * )
 */
class GeeklogTerm extends SqlBase {
  ...
  public function query() {
     ...
     * source plugin.
     */
    return $this->select('gl_topics', 'glt')
      ->fields('glt', ['tid', 'topic' ])
